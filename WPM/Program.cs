            ...
            if (WpmP)// Do WPM processing
            {
                ...
                if (File.Exists(wpmPath + wpmF))
                {
                    ...
                    2, 2, 13, 11, 15, 2});
                            ...
                            if (Directory.Exists("\\\\mexico\\datafiles\\data import\\"))
                            {
                                while (!tfp.EndOfData)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        writerX = new StreamWriter("\\\\mexico\\datafiles\\data import\\" + batchIDDate, true, Encoding.Unicode);// This is the OUTPUT file
                            ...
                            {
                                if (!File.Exists(wpmCopy)) File.Copy(wpmOut,wpmCopy);
                            }
